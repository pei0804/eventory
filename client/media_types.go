...
// DecodeGenreTiny decodes the GenreTiny instance encoded in resp body.
func (c *Client) DecodeGenreTiny(resp *http.Response) (*GenreTiny, error) {
	var decoded GenreTiny
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
...
// DecodeGenreTinyCollection decodes the GenreTinyCollection instance encoded in resp body.
func (c *Client) DecodeGenreTinyCollection(resp *http.Response) (GenreTinyCollection, error) {
	var decoded GenreTinyCollection
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return decoded, err
}
