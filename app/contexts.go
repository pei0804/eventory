...
func NewAppendGenreCronContext(ctx context.Context, service *goa.Service) (*AppendGenreCronContext, error) {
	var err error
...
func NewFixUserFollowCronContext(ctx context.Context, service *goa.Service) (*FixUserFollowCronContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewNewEventFetchCronContext(ctx context.Context, service *goa.Service) (*NewEventFetchCronContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewKeepEventsContext(ctx context.Context, service *goa.Service) (*KeepEventsContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewFollowGenresContext(ctx context.Context, service *goa.Service) (*FollowGenresContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewFollowPrefsContext(ctx context.Context, service *goa.Service) (*FollowPrefsContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewLoginUsersContext(ctx context.Context, service *goa.Service) (*LoginUsersContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewRegularCreateUsersContext(ctx context.Context, service *goa.Service) (*RegularCreateUsersContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewStatusUsersContext(ctx context.Context, service *goa.Service) (*StatusUsersContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewTmpCreateUsersContext(ctx context.Context, service *goa.Service) (*TmpCreateUsersContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
