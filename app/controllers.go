...
func MountCronController(service *goa.Service, ctrl CronController) {
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewAppendGenreCronContext(ctx, service)
		if err != nil {
			return err
		}
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewFixUserFollowCronContext(ctx, service)
		if err != nil {
			return err
		}
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewNewEventFetchCronContext(ctx, service)
		if err != nil {
			return err
		}
...
func MountEventsController(service *goa.Service, ctrl EventsController) {
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewKeepEventsContext(ctx, service)
		if err != nil {
			return err
		}
...
func MountGenresController(service *goa.Service, ctrl GenresController) {
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewFollowGenresContext(ctx, service)
		if err != nil {
			return err
		}
...
func MountPrefsController(service *goa.Service, ctrl PrefsController) {
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewFollowPrefsContext(ctx, service)
		if err != nil {
			return err
		}
		return ctrl.Follow(rctx)
...
func MountUsersController(service *goa.Service, ctrl UsersController) {
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewLoginUsersContext(ctx, service)
		if err != nil {
			return err
		}
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewRegularCreateUsersContext(ctx, service)
		if err != nil {
			return err
		}
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewStatusUsersContext(ctx, service)
		if err != nil {
			return err
		}
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewTmpCreateUsersContext(ctx, service)
		if err != nil {
			return err
		}
